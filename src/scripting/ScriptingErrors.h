 ...
 *
 * File: ScriptingErrors.h
 * Role: Scripting subsystem error codes and messages used to report Lua/bc integration failures consistently.
 */

#ifndef QMUD_SCRIPTINGERRORS_H
#define QMUD_SCRIPTINGERRORS_H
...
enum
{
	...
	eAliasAlreadyExists,         // attempt to add an alias that already exists - 30011
	...
	ePluginCouldNotSaveState,    // plugin could not save state (e.g. no directory) = 30038
