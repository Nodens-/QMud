...
class GlobalPreferencesDialog : public QDialog
{
	...
	private:
		...
		QHash<QString, QTableWidgetItem *> m_shortcutOverrideItems;
		...
		/**
		 * @brief Builds keyboard shortcut settings page.
		 * @return Shortcuts page widget.
		 */
		...
		/**
		 * @brief Validates current shortcut overrides.
		 * @return `true` when shortcut overrides are valid.
		 */
		bool                               validateShortcutOverrides();
