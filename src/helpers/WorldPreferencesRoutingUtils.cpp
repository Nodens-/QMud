...
namespace
{
	bool matchesCommand(const QMudWorldPreferencesRouting::CommandMatcher &isCommand,
...
namespace QMudWorldPreferencesRouting
{
	...
	{
		return cmdName == QStringLiteral("Preferences") ||
		       matchesCommand(isCommand, QStringLiteral("ConfigureMudAddress")) ||
		       cmdName == QStringLiteral("ConfigureConnecting") ||
		       cmdName == QStringLiteral("ConfigureChat") || cmdName == QStringLiteral("ConfigureLogging") ||
		       cmdName == QStringLiteral("ConfigureOutput") ||
		       ...
		       cmdName == QStringLiteral("ConfigureCommands") ||
		       ...
		       cmdName == QStringLiteral("ConfigureSendFile") ||
		       cmdName == QStringLiteral("ConfigureScripting") ||
		       cmdName == QStringLiteral("ConfigureVariables") ||
		       cmdName == QStringLiteral("ConfigureTimers") ||
		       cmdName == QStringLiteral("ConfigureTriggers") ||
